...
import { ChatActions, ChatState } from "@/Mediums/Chat/Utils/prompt&type";
    ...
    return (
        (
            chatState.messages?.length === 0 ? (
                <div className="w-full h-screen  flex flex-col items-center justify-center border-2 border-red-500">
